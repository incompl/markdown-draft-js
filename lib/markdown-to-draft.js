...
function markdownToDraft(string) {
  ...
  var md = new _remarkable.Remarkable(remarkablePreset, remarkableOptions); // Key generator for entityMap items
  ...
  parsedData.forEach(function (item) {
    ...
    if (itemType === 'inline') {
      ...
      var _parseInline = parseInline(item, BlockEntities, BlockStyles, generateUniqueKey),
